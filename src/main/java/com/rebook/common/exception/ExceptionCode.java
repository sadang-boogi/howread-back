...
public enum ExceptionCode {
    ...
    NOT_FOUND_STUDYGROUP_ID("NOT_FOUND", null, "해당 스터디그룹은 존재하지 않습니다."),
    NOT_FOUND_APPLICATION_ID("NOT_FOUND", null, "해당 신청을 찾을 수 없습니다."),

    UN_AUTHORIZED("UN_AUTHORIZED", "권한 없음", "권한이 없습니다."),
